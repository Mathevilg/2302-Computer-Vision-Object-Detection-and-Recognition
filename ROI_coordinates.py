...
def save_roi(dataset_folder, output_folder):
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python3 ROI_coordinates.py <dataset_folder> <output_folder>")
        sys.exit(1)
    dataset_folder = sys.argv[1]
    output_folder = sys.argv[2]
    save_roi(dataset_folder, output_folder)
    print("Hand detection with increased bounding box size saved in the output folder.")


# dataset_folder = "./Final/closed3/train"
# output_folder = "closed"
